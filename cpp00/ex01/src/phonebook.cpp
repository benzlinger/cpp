...
/*   Updated: 2022/09/09 13:53:31 by btenzlin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		PhoneBook::set_infos(void)
{
	...
	if (this->_index == 3)
		this->_index = 0;
	if (this->_amount_contacts < 2)
		this->_amount_contacts++;
	std::cout << this->_amount_contacts << std::endl;
}
...
void	PhoneBook::show_contact_info(int index)
{
	if (index >= 0 && index <= this->_amount_contacts)
	{
		...
		std::cout << "Invalid input or contact field empty. Please enter a number between 0 and " << this->_amount_contacts << std::endl;
}
...
void	PhoneBook::show_contacts(void)
{
	...
	else
	{
		...
		while (input < 0 || input > this->_amount_contacts)
		{
